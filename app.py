...
OS_DATA = {
    ...
    "💰 Descuentos de laboratorios": {
        ...
        "items": [
            ...
            ("Panalab — 40% descuento", "Cajas blancas con rayas de color. Ej: Folcres, Valcatil Max, Dutapil, Combinater, Terekol, Ribatra. <br><b>Si trae cupón:</b> cargar 'Descuento Panalab papel' → escanear cupón + matrícula + fecha. <br><b>Si no trae cupón:</b> usar matrícula 5555 y colocar la fecha del día de dispensa. En ambos casos: no sacar troquel."),
            ...
            ("Cassara / Sanitas", "Hay dos tipos de descuento. <br><b>1) Bono Dermo:</b> el paciente lo trae en el celular. En el PVF se carga como 'Descuento Cassara Bono Dermo', se escanea el voucher y se saca el troquel. No es necesario imprimir el voucher. <br><b>2) Cupón:</b> el paciente trae un cupón en papel con descuento del 25% o 40%. En el PVF se carga como 'Descuento Cassara Cupón', se saca el troquel y se guarda el cupón. <br><b>Particularidad Sanitas:</b> funciona igual, pero el PVF pide 'Voucher' y como no existe, hay que ingresar el DNI del paciente en ese campo."),
        ]
    },
    "💊 Vale Salud": {
        "icono": "💊",
